...
export function MatchesPage() {
  ...
  const matches: Match[] = [
    { id: 1, date: '2025-11-06', opponent: 'Al Ahli', competition: 'Premier League', result: 'W', score: '3-1', possession: 58, shots: 18, passes: 542 },
    { id: 2, date: '2025-11-02', opponent: 'Al Hilal', competition: 'Premier League', result: 'D', score: '2-2', possession: 52, shots: 14, passes: 498 },
    { id: 3, date: '2025-10-28', opponent: 'Al Shabab', competition: 'Premier League', result: 'L', score: '1-2', possession: 45, shots: 12, passes: 456 },
    { id: 4, date: '2025-10-24', opponent: 'Neom', competition: 'League Cup', result: 'W', score: '2-1', possession: 48, shots: 15, passes: 478 },
    { id: 5, date: '2025-10-20', opponent: 'AL HAZEM', competition: 'Premier League', result: 'W', score: '3-0', possession: 62, shots: 20, passes: 612 },
    { id: 6, date: '2025-10-16', opponent: 'Al Ettifaq', competition: 'Premier League', result: 'W', score: '2-1', possession: 55, shots: 16, passes: 523 },
  ];

  const playerStats = [
    { name: 'Merih Demiral', position: 'FW', goals: 2, assists: 1, shots: 6, passes: 42, rating: 8.9 },
    { name: 'Awadh Khamis', position: 'MF', goals: 1, assists: 1, shots: 3, passes: 68, rating: 8.2 },
    { name: 'Awadh Al-Saadi', position: 'MF', goals: 0, assists: 2, shots: 2, passes: 71, rating: 7.8 },
    { name: 'Awad Dahal', position: 'DF', goals: 0, assists: 0, shots: 1, passes: 54, rating: 7.5 },
  ];
